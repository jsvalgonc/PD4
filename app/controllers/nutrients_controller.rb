class NutrientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nutrient.save
        ...
        format.json { render action: 'show', status: :created, location: @nutrient }
      else
  ...
  private
    ...
    def nutrient_params
      params.require(:nutrient).permit(:nutrno, :units, :tagname, :nutrdesc, :numdec, :srorder, :activo)
    end
end
