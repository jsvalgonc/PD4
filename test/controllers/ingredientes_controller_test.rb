...
class IngredientesControllerTest < ActionController::TestCase
  ...
  test "should create ingrediente" do
    assert_difference('Ingrediente.count') do
      post :create, ingrediente: { descricao: @ingrediente.descricao, unidade_medida_id: @ingrediente.unidade_medida_id }
    end
  ...
  test "should update ingrediente" do
    patch :update, id: @ingrediente, ingrediente: { descricao: @ingrediente.descricao, unidade_medida_id: @ingrediente.unidade_medida_id }
    assert_redirected_to ingrediente_path(assigns(:ingrediente))
  end
